...
if args.method == "scramble":
    train_set = load_dataset_scramble(args.data_prefix + ".train")
else:
...
if args.method == "transfer" or args.method == "scramble":
    transfer(model, train_set, dev_set, lr_inner=args.lr_inner, inner_batch_size=args.inner_batch_size, 
         print_every=args.print_every, patience=args.patience, save_prefix=args.save_prefix)
